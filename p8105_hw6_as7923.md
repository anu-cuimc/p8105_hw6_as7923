...
CI: 0.894 - 0.928). This indicates that the model consistently explains
...
**β₁/β₂ distribution:** The distribution of β₁/β₂ is highly skewed (95%
CI: -5542.9 - 4629.8). This occurs because β₂ (the coefficient for
precipitation) is negative and very close to zero, making the ratio
unstable. Small changes in β₂ near zero create large fluctuations in the
ratio, resulting in the wide confidence interval. This suggests high
uncertainty in estimating this specific quantity.
